...
<div class="box">
	...
	<c:otherwise>
<a href="${pageContext.request.contextPath}/HouseSelectWithPageServlet?page=${page.currentPage-1}">上一页</a>
	</c:otherwise>
	</c:choose>
	...
	<c:otherwise>
<a href="${pageContext.request.contextPath}/HouseSelectWithPageServlet?page=${page.currentPage+1}">下一页</a>
	</c:otherwise>
	</c:choose>
	</div>
